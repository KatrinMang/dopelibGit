...
#define TSP ShiftedCrankNicolsonProblem //FractionalStepThetaProblem //CrankNicolsonProblem

// Bisher nur stueckweise - noch Arbeit noetig!!!
#define DTSP ShiftedCrankNicolsonProblem //FractionalStepThetaProblem //CrankNicolsonProblem
